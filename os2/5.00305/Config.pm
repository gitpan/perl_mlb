...
$] == 5.00305
  or die "Perl lib version (5.00305) doesn't match executable version ($])";
...
my $config_sh = <<'!END!';
archlibexp='f:/perllib/lib/os2/5.00305'
archname='os2'
cc='gcc'
ccflags='-Zomf -Zmt -DDOSISH -DOS2=2 -DEMBED -I. -DPACK_MALLOC -DDEBUGGING_MSTATS'
cppflags='-Zomf -Zmt -DDOSISH -DOS2=2 -DEMBED -I. -DPACK_MALLOC -DDEBUGGING_MSTATS'
dlsrc='dl_dlopen.xs'
dynamic_ext='DB_File Fcntl FileHandle IO OS2::ExtAttr OS2::PrfDB OS2::Process OS2::REXX Opcode POSIX SDBM_File Socket'
extensions='DB_File Fcntl FileHandle IO OS2::ExtAttr OS2::PrfDB OS2::Process OS2::REXX Opcode POSIX SDBM_File Socket'
installarchlib='f:/perllib/lib/os2/5.00305'
installprivlib='f:/perllib/lib'
libpth='f:/emx/lib/mt f:/emx/lib'
libs='-lsocket -lm'
osname='os2'
osvers='2.30'
prefix='f:/perllib'
...
aphostname=''
ar='emxomfar'
archlib='f:/perllib/lib/os2/5.00305'
...
cf_time='Sat Oct  5 15:46:41 PDT 1996'
chgrp=''
chmod=''
chown=''
clocktype='clock_t'
...
intsize='4'
known_extensions='DB_File Fcntl FileHandle GDBM_File IO NDBM_File ODBM_File OS2::ExtAttr OS2::PrfDB OS2::Process OS2::REXX Opcode POSIX SDBM_File Socket'
ksh=''
large=''
ld='gcc'
...
shar=''
shmattype=''
shrpenv='env LD_RUN_PATH=f:/perllib/lib/os2/5.00305/CORE'
