...
$] == 5.00401
  or die "Perl lib version (5.00401) doesn't match executable version ($])";
...
my $config_sh = <<'!END!';
archlibexp='f:/perllib/lib/os2/5.00401'
archname='os2'
cc='gcc'
...
installarchlib='f:/perllib/lib/os2/5.00401'
...
aout_lddlflags='-Zdll'
aout_ldflags='-Zexe -Zsmall-conv -s'
aout_lib_ext='.a'
aout_obj_ext='.o'
aout_plibext='.a'
aout_use_clib='c'
...
aphostname=''
ar='emxomfar'
archlib='f:/perllib/lib/os2/5.00401'
...
cf_time='Mon Jun 16 12:07:45 PDT 1997'
chgrp=''
chmod=''
chown=''
clocktype='clock_t'
...
shmattype=''
shortsize='2'
shrpenv='env LD_RUN_PATH=f:/perllib/lib/os2/5.00401/CORE'
signal_t='void'
