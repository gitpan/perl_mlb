...
$] == 5.00455
  or die "Perl lib version (5.00455) doesn't match executable version ($])";
...
my $config_sh = <<'!END!';
archlibexp='f:/perllib/lib/os2/5.00455'
archname='os2'
cc='gcc'
...
dlsrc='dl_dlopen.xs'
dynamic_ext='DB_File Fcntl IO OS2/ExtAttr OS2/PrfDB OS2/Process OS2/REXX Opcode POSIX SDBM_File Socket attrs'
extensions='DB_File Fcntl IO OS2/ExtAttr OS2/PrfDB OS2/Process OS2/REXX Opcode POSIX SDBM_File Socket attrs'
installarchlib='f:/perllib/lib/os2/5.00455'
...
aphostname=''
ar='emxomfar'
archlib='f:/perllib/lib/os2/5.00455'
...
cf_time='Wed Nov 26 18:29:32 PST 1997'
chgrp=''
chmod=''
chown=''
clocktype='clock_t'
...
intsize='4'
known_extensions='DB_File Fcntl GDBM_File IO NDBM_File ODBM_File OS2/ExtAttr OS2/PrfDB OS2/Process OS2/REXX Opcode POSIX SDBM_File Socket Thread attrs'
ksh=''
large=''
ld='gcc'
...
shmattype=''
shortsize='2'
shrpenv='env LD_RUN_PATH=f:/perllib/lib/os2/5.00455/CORE'
signal_t='void'
